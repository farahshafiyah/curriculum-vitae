       ...
       <section class="content">
        <div class="container-fluid">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            <?php foreach($whatsapp as $data) {?>
            <tr>
            <td><?php echo $data->id ?></td>
            <td><?php echo $data->link ?></td>
            <td>
              <a class="btn btn-warning" href="<?php echo site_url('admin/whatsapp/edit/'.$data->id)?>">
                <i class="fa fa-edit"></i>
              </a>

              </a>
              <a type="button" rel="tooltip" title="Hapus" class="btn btn-danger" onclick="deleteConfirm('<?php echo site_url('admin/whatsapp/delete/'.$data->id)?>')">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="<?= base_url('admin/whatsapp/add')?>" method="post">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-grup">
                    <label>Id</label>
              ...
              <div class="row">
                  <div class="col-md-6">
                    <div class="form-grup">
                    <label>Link</label>
                    <input type="text" name="link" class="form-control" placeholder="Foto . ." value="">
                  </div>
                </div>
              </div>
            </div>
