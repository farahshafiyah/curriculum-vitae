...
<section class="content">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php base_url('admin/whatsapp/edit') ?>" method="post" enctype="multipart/form-data" >
                <div class="card-body">
                <input type="hidden" name="id" value="<?php echo $whatsapp->id ?>" />

                <div class="form-group">
                    <label for="link">Link</label>
                    <input type="text" value="<?php echo $whatsapp->link ?>" class="form-control <?php echo form_error('link') ? 'is-invalid':'' ?>" id="link" placeholder="link" name="link">
