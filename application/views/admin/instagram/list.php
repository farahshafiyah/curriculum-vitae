       ...
       <section class="content">
        <div class="container-fluid">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <td>
              <a class="btn btn-warning" href="<?php echo site_url('admin/link/edit/'.$data->id)?>">
                <i class="fa fa-edit"></i>
              </a>

              </a>
              <a type="button" rel="tooltip" title="Hapus" class="btn btn-danger" onclick="deleteConfirm('<?php echo site_url('admin/instagram/delete/'.$data->id)?>')">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="<?= base_url('admin/instagram/add')?>" method="post">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-grup">
                    <label>Id</label>
