...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="card-header">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">Tambah Skill
            </button>
          </div>
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <th style="width: 20%;">Keterangan Skill</th>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Tambah Skill</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              ...
              <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="nm_skill" class="form-control" placeholder="Nama Skill . ." value="">
                  </div>
                </div>
              </div>
              <div class="row">
                  <div class="col-md-6">
                    <div class="form-grup">
                    <label>Keterangan Skill</label>
                    <input type="text" name="ket_skill" class="form-control" placeholder="Nama Skill . ." value="">
                  </div>
                </div>
              </div>
            </div>
