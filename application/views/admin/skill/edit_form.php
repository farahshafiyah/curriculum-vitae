            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/skill/edit') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $skill->nama_skill ?>" class="form-control <?php echo form_error('nama_skill') ? 'is-invalid':'' ?>" id="nama_skill" placeholder="Info" name="nama_skill">
                ...
                <div class="form-group">
                    <label for="ket_skill">Keterangan Skill</label>
                    <input value="<?php echo $skill->ket_skill ?>" type="text" class="form-control <?php echo form_error('ket_skill') ? 'is-invalid':'' ?>" id="ket_skill" placeholder="Keterangan Skill" name="ket_skill">
                    <div class="invalid-feedback">
